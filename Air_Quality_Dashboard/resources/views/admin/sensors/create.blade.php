                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('sensor_id') is-invalid @enderror" 
                                   id="sensor_id" name="sensor_id" value="{{ old('sensor_id') }}" required>
                            @error('sensor_id')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('latitude') is-invalid @enderror" 
                                           id="latitude" name="latitude" value="{{ old('latitude') ?? request()->get('lat') ?? 6.927079 }}" required readonly>
                                    @error('latitude')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('longitude') is-invalid @enderror" 
                                           id="longitude" name="longitude" value="{{ old('longitude') ?? request()->get('lng') ?? 79.861243 }}" required readonly>
                                    @error('longitude')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            </div>
                            <div class="form-text mt-1">Click on the map to set coordinates</div>
                        </div>
                        ...
                        <div class="form-check form-switch mb-3">
                            ...
                            <div class="form-text">Sensor will be activated immediately upon creation</div>
                        </div>
                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Create a marker initially at the specified or default position
        var marker = L.marker([initialLat, initialLng], {
            draggable: true
        }).addTo(map);
        
        // Update form fields with initial marker position
